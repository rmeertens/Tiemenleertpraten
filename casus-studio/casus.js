const cases = [
  {
    ...
    example: {
      ...
      scores: "Ik rapporteer puntscore én betrouwbaarheidsinterval. Omdat het BI rond de grenszone ligt, combineer ik de normscore met observatie, verstaanbaarheid en participatie. Begrip en productie worden apart benoemd.",
