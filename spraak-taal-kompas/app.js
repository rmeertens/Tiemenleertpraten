const domains = [
  ...
  },
  {
    ...
    concepts: [
      ...
      concept("ICF-brug", "10-component", "Maak steeds de brug van functie naar activiteit en participatie. Voorbeeld: zwakke morfosyntaxis maakt vertellen minder begrijpelijk, waardoor het kind afhaakt in kringgesprekken en ondersteuning nodig heeft in klasinteractie.", "Mondeling therapie: doelen, therapievorm, samenwerking en prognose. Schriftelijk: interventieplan.", "ICF-termen los noemen zonder concreet dagelijks gevolg.", "Kun je één functieprobleem vertalen naar één activiteit, één participatieprobleem en één omgevingsaanpassing?")
    ]
  },
  {
